...
public class GeldbetragTest {
	...
	public GeldbetragTest(){
		_g1 = new Geldbetrag(10,20,true);
		_g2 = new Geldbetrag(6,30,true);
		_g3 = new Geldbetrag(10,80,true);
	}
	
	//@Test
	/*public void testAdd(){
		Geldbetrag _g0 = new Geldbetrag(16,50,true);
	...
	@Test
	public void testMul(){
		Geldbetrag _g0 = new Geldbetrag(20,40,true);
